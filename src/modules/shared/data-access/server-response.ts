...
export const createServerErrorResponse = <ResponseData>(error: any): ServerResponse<ResponseData> => {
...
export const createServerSuccessResponse = <ResponseData>(data: ResponseData): ServerResponse<ResponseData> => {
  return { data }
}
